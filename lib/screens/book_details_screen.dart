  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar: Container(
        height: 49,
        margin: const EdgeInsets.only(top: 8, left: 25, right: 25, bottom: 25),
        ...
        child: FlatButton(
          ...
          child: const Text('Add to library', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.white),),
